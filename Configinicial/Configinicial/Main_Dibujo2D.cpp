...
int main() {
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//primer elemento del arreglo (GL_POINTS,0,1), si se quieren poner mas puntos,
		...
		//este es el arreglo de vertices, se dibuja una linea entre el primer y segundo punto del arreglo
		 
        //glDrawArrays(GL_LINES,0,2);

		//cierra los vertices, formando un cuadrado 
        //glDrawArrays(GL_LINE_LOOP,0,4);
        

		//dibuja un triangulo con los tres primeros vertices del arreglo
        //glDrawArrays(GL_TRIANGLES,0,3);
		

		// dibuja un triangulo con los tres primeros vertices del arreglo, 
		// pero con indices, es decir, se dibuja el triangulo con los vertices 3,2 y 1 del arreglo
